    ...
    render() {
        ...
        return (<div className="ItemsListRow" onMouseLeave={() => {
            ...
            <Row key={"row" + this.props.serial}>
                <Col sm={5} key={"colname" + this.props.serial}>
                    <div>{this.props.itemName}</div></Col>
                <Col sm={2} key={"colqty" + this.props.serial}><input className="form-control" type="text" value={this.state.qty} onChange={(event) => {
