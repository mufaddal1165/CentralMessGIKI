...
export default class ItemsList extends React.Component {
  ...
  render() {
    const cross = (<img src="../icons/cross.png" key={this.props.serial+"cross"} width="9rem" height="9rem" onClick={()=>{this.props.crosshandle(this.props.serial)}}></img>)

    return (<div className="ItemsListRow"  onMouseLeave={()=>{this.setState({hover:true}); console.log('Leave')}} onMouseEnter={()=>{this.setState({hover:false}); console.log('Entered '+this.props.serial)}}>
